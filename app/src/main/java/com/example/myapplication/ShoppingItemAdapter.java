...
public class ShoppingItemAdapter
    ...
    // Member variables.
    private ArrayList<com.example.myapplication.ShoppingItem> mShoppingData;
    private ArrayList<com.example.myapplication.ShoppingItem> mSoppingDataAll;
    private Context mContext;
    private int lastPosition = -1;

    ShoppingItemAdapter(Context context, ArrayList<com.example.myapplication.ShoppingItem> itemsData) {
